...
class Modal {
    ...
    open(e1) {
        ...
        if (!this.openTimeLine.isEmpty && this.state !== "active") this.openTimeLine.notify(e1);
        this.status = "active";
    }
    // close modal
    // change [ status ]
    close(e1) {
        ...
        if (!this.closeTimeLine.isEmpty && this.state !== "inactive") this.closeTimeLine.notify(e1);
        this.status = "inactive";
    }
    // open - close modal
    // change status
    ...
    bindToggler(...elements) {
        ...
        elements.forEach((element)=>{
            ...
            element.addEventListener("click", (e1)=>this.toggle.call(this, e1));
        });
        return this;
    }
    ...
    bindOpener(...elements) {
        elements.forEach((element)=>{
            ...
            element.addEventListener("click", (e1)=>this.open.call(this, e1, true));
        });
        return this;
    }
    ...
    bindCloser(...elements) {
        elements.forEach((element)=>{
            ...
            element.addEventListener("click", (e1)=>this.close.call(this, e1));
        });
        return this;
    }
...
//# sourceMappingURL=index.b82e4322.js.map

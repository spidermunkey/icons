export default class Icon {
    constructor(props) { // => returns dom element
        this.observer = this.deepClone(props);
        this.static = props;
        ...
        function setDefaultDimensions() {
            ...
            if (height)
                ...
                this.observer.height = "24px"
                element.setAttribute('height',"24px")
            }
            if (width)
                this.observer.width = width;
            else {
                this.observer.width = "24px"
        ...
        function getColors() {
            ...
            if (fill)
                this.observer.fill = fill;
            else if (fill === 'none' || !fill)
                this.observer.fill = 'none'
            if (stroke)
                this.observer.stroke = stroke;
            else if (stroke === 'none' || !stroke)
                this.observer.stroke = 'none'
        }
        function getPaths() {
        ...
        function preFormat() {
            ...
            this.observer.markup = element.outerHTML;
        }
        preFormat();
    }
    ...
    update() {
        ...
        this.observer = this.deepClone(this.static);
